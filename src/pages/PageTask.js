...
class PageTask extends React.Component {
  ...
  valoresUpdate = (id) => {
    ...
    let datas = qs.stringify({
      data:
        '{ "name":"' +
        this.state.dataid.name +
        '", "title":"' +
        this.state.dataid.title +
        '", "compled":"' +
        valorstatus +
        '" }',
    });
    ...
    return (
      <div className="headcont">
        ...
        <div className="table-responsive">
                    ...
                    <th>
                      {(() => {
                        switch (task.completed) {
                          case 1:
                            return (
                              <button
                                ...
                                onClick={() => this.optenerValor(task.id)}
                              >
                          ...
                          default:
                            return <img src={img} className="checks" />;
                        }
                      })()}
                    </th>
                    <td>{task.title}</td>
          ...
          <div
            id="myModalRight"
            class="modal fade modal-right mdsize"
            tabindex="-1"
            role="dialog"
          >
            <div class="modal-dialog respos" role="document">
              <div class="modal-content">
                <div className="modal-header mdgrid0">
                  <button
                    type="button"
                    className="close mdgrid1"
                    data-dismiss="modal"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">&times;</span>
                  </button>
                  <h4 className="modal-title mdgrid2">
                    {" "}
                    <strong> {this.state.dataid.title} </strong>
                  </h4>
                  ...
                  {(() => {
                    switch (this.state.dataid.completed) {
                      case 1:
                        return (
                          <select
                            className="form-control mdgrid3"
                            id="statusup"
                          >
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <textarea
                      class="form-control texx"
                      name="name"
                      id="nameup"
                      rows="5"
                      value={this.state.dataid.name}
                ...
                <div class="modal-footer foote">
                  <div className="btns">
                    <button
                      ...
                      id="statusup"
                      data-dismiss="modal"
                      onClick={() => this.valoresUpdate(this.state.dataid.id)}
                    >
                  ...
                  <div className="btns">
                    <button
                      ...
                      class="btn btnn"
                      data-dismiss="modal"
                      onClick={() => this.peticionDelete(this.state.dataid.id)}
                    >
